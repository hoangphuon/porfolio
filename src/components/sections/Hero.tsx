    ...
    >
      <div className="z-10">
        ...
        >
          ...
          <div className="w-80 h-28 md:w-[700px] md:h-40 flex items-center justify-center overflow-hidden rounded-[40px] border-b-4 border-neonBlue/50 shadow-[0_20px_60px_-15px_rgba(0,243,255,0.3)] mx-auto relative group bg-[#0a0a0a]">
            <h2 className="text-4xl md:text-7xl font-black tracking-[0.2em] text-white font-mono relative z-20">
              {displayText}
              <motion.span
                animate={{ opacity: [0, 1, 0] }}
                transition={{ repeat: Infinity, duration: 0.8 }}
                className="inline-block w-1.5 h-10 md:h-20 bg-neonBlue ml-2"
              />
            </h2>
            
            {/* Tech effects */}
            <div className="absolute inset-0 bg-neonBlue/5 pointer-events-none mix-blend-overlay" />
            <div className="absolute inset-0 shadow-[inset_0_0_100px_rgba(0,0,0,0.9)] pointer-events-none" />
            
            {/* Scanline effect */}
            <div className="absolute inset-0 bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.25)_50%),linear-gradient(90deg,rgba(0,243,255,0.06),rgba(0,255,0,0.02),rgba(255,0,0,0.02))] bg-[length:100%_4px,3px_100%] pointer-events-none opacity-30" />
          </div>
          
          {/* Intense light streak behind text */}
          <div className="absolute -inset-24 bg-neonBlue/10 blur-[130px] -z-10" />
        </motion.div>
        ...
        <motion.h1
          ...
          style={{ textShadow: "0 0 20px rgba(0, 243, 255, 0.1)" }}
        >
